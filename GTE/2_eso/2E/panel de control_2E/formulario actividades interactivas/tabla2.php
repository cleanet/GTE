...
<?php
    ...
    $query = "SELECT * FROM 2eso LIMIT $empieza, $por_pagina";
    $res = $conexion->query($query);
    if ($res->num_rows > 0) {
        echo "<div id='table-container'>";
        echo "<table id='tabla1'>";
        echo "<tr>";
        echo "<th colspan='4' width='1000'><center><font face='segoe script' color='#333333'>Actividades Interactivas de 2 ESO</font></center></th>";
        echo "</tr>";
        echo "<tr>";
