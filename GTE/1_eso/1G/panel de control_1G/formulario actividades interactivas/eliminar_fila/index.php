<html>
  <head>
    <title>Actividades interactivas | 1 eso</title>
    <meta charset="utf-8">
    <link rel="icon" type="image/ico" href="/imagenes/logo_GTE.png">
  ...
  <font class="title_1A" style="left:28%;">Eliminar fila | 1 ESO </font>
  <div class="body_div">
    <center>
      <form id="demo" action="" method="post" name="captcha-form">
       ...
       <br>
       <input type="text" name="id" placeholder="ID aqu&iacute;" id="data">
       <br>
       ...
       <br>
       <input type="checkbox" name="fruit-1" id="fruit1"><label for="fruit1"><font face="segoe script" id="texto_eliminar_tabla">Eliminar <b><u>todos</u></b> los datos de la tabla</font></label>
       <br>
       <br>
       <button type="submit" name="Enviar" class="btn" title="Guardar evento" id="enviar_eliminacion"><i class="fa fa-check-square-o  enviar1"></i></button>&nbsp;&nbsp;<button type="reset" name="eliminar" class="btn" title="Limpiar formulario"><i class="fa fa-eraser  borrar1"></i></button>
      </form>
