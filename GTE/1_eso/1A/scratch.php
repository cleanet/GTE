<?php
	...
	if ($limite > 0) {
		...
		echo "<aside class=\"anterior_scratch\" onclick='cargarproductos_scratch(".$limit.");' style='color:transparent; background:transparent;'></aside>";
	}
	...
	if ($limite<$total-5) {
		...
		echo "<aside class=\"siguiente_scratch\" onclick='cargarproductos_scratch(".$limit.");' style='color:transparent; background:transparent;'></aside>";
	}
	echo "</div>";
?>