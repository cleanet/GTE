<html>
  ...
  <body id="fondo" ondragstart="return false;" onmousedown="return false;">
    <div>
      ...
      <li class="fa fa-pencil-square" onclick="location.href='panel de control_1A'" title="A&ntilde;adir eventos" id="eventos1"></li>
    ...
    <!--popup actividades interactivas-->
    <div id="fondo_popup">
      <div id="popup_elegir">
        ...
        <div id="popup_educaplay">
          ...
          <div id="contenedor"><div class="navegacion_actividades_educaplay"><aside class="anterior_educaplay" style="background: transparent; color: transparent;"></aside><aside class="siguiente_educaplay" style="background: transparent; color: transparent;"></aside></div></div>
        </div>
        <div id="popup_scratch">
          <p id="title_scratch"><b id="texto_scratch">SCRATCH</b><i class="fa fa-close close_popup_scratch"></i></p>
          <div id="contenedor_scratch"><div class="navegacion_actividades_scratch"><aside class="anterior_scratch" style="background: transparent; color: transparent;"></aside><aside class="siguiente_scratch" style="background: transparent; color: transparent;"></aside></div></div>
        </div>
        <div id="popup_learnclick">
          <p id="title_learnclick"><b>Learn</b>click<i class="fa fa-close close_popup_learnclick"></i></p>
          <div id="contenedor_learnclick"></div><div class="navegacion_actividades_learnclick"><aside class="anterior_learnclick" style="background: transparent; color: transparent;"></aside><aside class="siguiente_learnclick" style="background: transparent; color: transparent;"></aside></div></div>
        </div>
      </div>
    </div>
    <!--script type="text/javascript" src="calendario/funciones_calendario.js"></script-->
  </body>
</html>