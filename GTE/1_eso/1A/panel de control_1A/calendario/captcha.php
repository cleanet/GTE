...
if (file_exists("imagenes/captcha.png")){
  $captchaImage = imagecreatefrompng( "imagenes/captcha.png" );
}else{
  $captchaImage = imagecreatefrompng( "../imagenes/captcha.png" );
}
...
if (file_exists("imagenes/captcha.png")){
    $imageInfo = getimagesize( "imagenes/captcha.png" );
}else{
  $imageInfo = getimagesize( "../imagenes/captcha.png" );
}
...
*/
if(file_exists("fonts/VeraBd.ttf")){
    $font = "fonts/VeraBd.ttf";
}else{
    $font = "../fonts/VeraBd.ttf";
}
imagettftext( $captchaImage, 20, 0, 35, 35, $textColor, $font, $key );

// Output the image to the browser, header settings prevent caching

header ( "Content-type: imagenes/png" );
