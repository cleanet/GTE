        ...
        $("#enviar_act").click(function(){
          ...
          if (y=="scratch_elegir") {
            ...
            $.ajax({
              ...
              beforeSend:function(){
                var d = new Date();
                $("#div_captcha").html("<img src='captcha.php? "+ d.getTime() +"' border='0' class='captcha_img1' vspace='3'/>&nbsp;<input type='text' name='code' width='25' required  id='captcha1' maxlength='8'/>");
              },
              success:function(e){
                if (e!=1) {
                  $(".popup_errorcaptchaevento").delay(500).slideDown("slow");
