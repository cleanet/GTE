<html>
<head>
  <title>calendario | 4 eso D</title>
  <meta charset="utf-8">
...
<div class="gridwrapper" id="header1">
  ...
  <font  class="title_1A">4 ESO D</font>
  <?php
...
<div>
    <center>
       <font face="segoe script" color="#333333" class="titulo_form_mod">Modificar eventos</font>
       <br>
       <font face="segoe script" color="#333333" class="especificar_evento"><li class="lista"><b><u>Especifica el evento:</u></b></li></font>
       <br>
       <br>
       <form id='demo' method='post' name='captcha-form'>
           <font face="segoe script" color="#333333" id="cambiartexto_especificar" class="materia_text_form">ID:</font>
           <br>
           <input type="number" name="seleccionar_id" id="seleccionar_id" oncut="return false" onpaste="return false" oncut="return false" placeholder=" Escribe aqu&iacute; el id del evento..." required class="campo_evento">
           <br>
           <font face="segoe script" color="#333333" class="especificar_evento"><li class="lista"><b><u>Modifica el evento:</u></b></li></font>
           <br>
           <br>
           ...
           <br>
           <textarea name="modificar_tareabox" cols="50" rows="10" placeholder="Escribe aqu&iacute;..." required id="tarea"></textarea>
           <br>
           ...
           <br>
           <br>
           <button type="submit" name="Enviar" class="btn" title="Modificar evento" id="enviar_modificacion"><i class="fa fa-check-square-o  enviar1"></i></button>&nbsp;&nbsp;<button type="reset" name="eliminar" class="btn" title="Limpiar formulario"><i class="fa fa-eraser  borrar1"></i></button>
      </form>
    </center>
