<html>
  ...
  <body id="fondo" ondragstart="return false;" onmousedown="return false;">
    <div>
      ...
      <li class="fa fa-pencil-square" onclick="location.href='panel de control_3D'" title="A&ntilde;adir eventos" id="eventos1"></li>
      <li class="fa fa-puzzle-piece" id="ver_actividades" title="Ver actividades interactivas"></li>
      <font id="title_1A">3 ESO D</font>
      <?php
