    ...
    <div>
      <div class="gridcontainer">
        ...
        <div class="gridwrapper contenido" id="body">
          ...
          <center>
            <font class="ESO"> 3 ESO</font>
          </center>
          <div class="btn_ESO">
            <img src="imagenes/3A.png" class="imagenes_ESO  btn_ESO_3_A  image_ESO">
            <img src="imagenes/3B.png" class="imagenes_ESO  btn_ESO_3_B  image_ESO">
            <img src="imagenes/3C.png" class="imagenes_ESO  btn_ESO_3_C  image_ESO">
            <img src="imagenes/3D.png" class="imagenes_ESO  btn_ESO_3_D  image_ESO">
            <img src="imagenes/3E.png" class="imagenes_ESO  btn_ESO_3_E  image_ESO">
            <img src="imagenes/3F.png" class="imagenes_ESO  btn_ESO_3_F  image_ESO">
          </div>
         <img src="imagenes/lapiz_separador_1.png" class="lapiz">
          <span id="popup">
            <center>
             <font face="segoe script" color="#333333" id="act_int1">Actividades Interactivas de 3 ESO (enlaces)</font>
            </center>
