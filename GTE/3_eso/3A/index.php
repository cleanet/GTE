...
<div class="gridwrapper" id="header1">
  ...
  <li class="fa fa-pencil-square" onclick="location.href='panel de control_3A'" title="A&ntilde;adir eventos" id="eventos1"></li>
  <li class="fa fa-puzzle-piece" id="ver_actividades" title="Ver actividades interactivas"></li>
  <font id="title_1A">3 ESO A</font>
  <?php
