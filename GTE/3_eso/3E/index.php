...
<div class="gridwrapper" id="header1">
  ...
  <li class="fa fa-pencil-square" onclick="location.href='panel de control_3E'" title="A&ntilde;adir eventos" id="eventos1"></li>
  <li class="fa fa-puzzle-piece" id="ver_actividades" title="Ver actividades interactivas"></li>
  <font id="title_1A">3 ESO E</font>
  <?php
  ...
  <table align="center" class="legenda_calendario">
    <tbody>
      <tr><th colspan="2" class="subtitulo">Inicio de curso y vacaciones</th>
