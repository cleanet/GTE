<html>
  <head>
    ...
    <script src="/plugins/jquery-latest.js"></script><!-- Este script permite el menú fijo / This script lets fixed menu-->
  </head>
  <body  id="fondo1">
    <div>
      <div class="gridcontainer">
        ...
        <div class="gridwrapper" id="header1">
          <a href="/">
            <img src="/errores/imagenes/logo_GTE.png" class="logo_inicio" id="logo_inicio1">
          </a>
        </div>
        <!-- contenido / content -->
        <div class="gridwrapper contenido" id="body">
          ...
          <center>
            <font class="ESO">ESO</font>
          </center>
          <!-- accesos a los cursos de la ESO / access to ESO courses -->
          <div class="btn_ESO">
            <img src="imagenes/1eso_pizarra.png" class="imagenes_ESO  btn_ESO_1_eso  image_ESO">
            <img src="imagenes/2eso_pizarra.png" class="imagenes_ESO  btn_ESO_2_eso  image_ESO">
            <img src="imagenes/3eso_pizarra1.png" class="imagenes_ESO  btn_ESO_3_eso  image_ESO">
            <img src="imagenes/4eso_pizarra1.png" class="imagenes_ESO  btn_ESO_4_eso  image_ESO">
          </div>
        </div>
