<html>
  <head>
    ...
    <link rel="icon" type="image/png" href="/profesorado/imagenes/logo_GTE_profesorado.png">
    <link rel="stylesheet" type="text/css" href="estilos.css">
    <link rel="stylesheet" type="text/css" href="tabla/estilos.css">
    <meta name="viewport" content="width=device-width">
    <meta charset="utf-8">
    <script src="/plugins/jquery_1.11.3.min.js"></script><!-- Este script permite el jquery externo / This script lets external jquery-->
    <script src="/plugins/jquery-lastest.js"></script><!-- Este script permite el menu fijo / This script lets the fixed menu -->
    ...
    <div>
      <div class="gridcontainer">
        ...
        <div class="gridwrapper contenido" id="body">
          ...
          <center>
            <font class="ESO"> 1 ESO</font>
          </center>
          <!-- acceso a las clases / classes access-->
          <div class="btn_ESO">
            <img src="imagenes/1A.png" class="imagenes_ESO  btn_ESO_1_A  image_ESO">
            <img src="imagenes/1B.png" class="imagenes_ESO  btn_ESO_1_B  image_ESO">
            <img src="imagenes/1C.png" class="imagenes_ESO  btn_ESO_1_C  image_ESO">
            <img src="imagenes/1D.png" class="imagenes_ESO  btn_ESO_1_D  image_ESO">
            <img src="imagenes/1E.png" class="imagenes_ESO  btn_ESO_1_E  image_ESO">
            <img src="imagenes/1F.png" class="imagenes_ESO  btn_ESO_1_F  image_ESO">
            <img src="imagenes/1G.jpg" class="imagenes_ESO  btn_ESO_1_G  image_ESO">
          </div>
          <br>
         <img src="imagenes/lapiz_separador_1.png" class="lapiz">
          <span id="popup">
            <center>
             <font face="segoe script" color="#333333" id="act_int1">Actividades Interactivas de 1 ESO (enlaces)</font>
            </center>
        ...
        <!-- tabla de actividades interactivas / interactive activities table -->
        <center>
