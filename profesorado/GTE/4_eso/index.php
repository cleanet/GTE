    ...
    <div>
      <div class="gridcontainer">
        ...
        <div class="gridwrapper contenido" id="body">
              ...
              <ul class="submenus">
                <li class="dropdown">
                  ...
                  <div class="dropdown-content">
                    ...
                    <a href="/profesorado/GTE/1_eso/1F">1&ordm; G</a>
                  </div>
                </li>
                <li class="dropdown">
          ...
          <center>
            <font class="ESO"> 4 ESO</font>
          </center>
          <div class="btn_ESO">
            <img src="imagenes/4A.png" class="imagenes_ESO  btn_ESO_4_A  image_ESO">
            <img src="imagenes/4B.png" class="imagenes_ESO  btn_ESO_4_B  image_ESO">
            <img src="imagenes/4C.png" class="imagenes_ESO  btn_ESO_4_C  image_ESO">
            <img src="imagenes/4D.png" class="imagenes_ESO  btn_ESO_4_D  image_ESO">
            <img src="imagenes/4E.png" class="imagenes_ESO  btn_ESO_4_E  image_ESO">
            <img src="imagenes/4F.png" class="imagenes_ESO  btn_ESO_4_F  image_ESO">
          </div>
         <img src="imagenes/lapiz_separador_1.png" class="lapiz">
          <span id="popup">
            <center>
             <font face="segoe script" color="#333333" id="act_int1">Actividades Interactivas de 4 ESO (enlaces)</font>
            </center>
