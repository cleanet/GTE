<html>
  <head>
    ...
    <link rel="icon" type="image/png" href="imagenes/logo_GTE_profesorado.png">
  </head>
  <body id="fondo1">
    <div>
              ...
              <ul class="slides">
                  <li>
                      ...
                      <section class="flex-caption" id="contenido_portada">
                        <div class="logo_page">
                          <img src="imagenes/logo_GTE_profesorado.png" id="logoGTE" style="">
                        </div>
